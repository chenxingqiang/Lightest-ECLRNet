...
class DynamicTopkAssigner(BaseAssigner):
    ...
    2) Lightest-CLRNet: LaneIoU and classification scores.
    ...
    Args:
        ...
        cost_combination (int): cost calculation type. 0: CLRNet, 1: Lightest-CLRNet.
    ...
    def _Lightest-CLRNet_cost(self, predictions, targets, pred_xs, target_xs):
        """_summary_
